...
export const dictionary = {
  vi: {
    ...
    'tab.teams': 'Đội ngũ',
    'detail.ready_to_launch': 'Sẵn sàng Launch',
    'detail.approved_desc':
      'Dự án của bạn đã được duyệt! Đã đến lúc đưa nó lên Blockchain.',
    'detail.publish_btn': 'Đưa lên Blockchain',
    'detail.funding_progress': 'Tiến trình gọi vốn',
    'detail.raised': 'đã gọi',
    'detail.goal': 'Mục tiêu',
    'detail.fund_btn': 'Đầu tư dự án này',
    'detail.project_status': 'Trạng thái dự án',
    'detail.active_status_desc':
      'Dự án này đã đạt mục tiêu gọi vốn và đang thực hiện các giai đoạn phát triển.',
    'detail.project_completed': 'Dự án đã hoàn thành',
    'detail.success_status_desc':
      'Dự án này đã hoàn thành xuất sắc tất cả các giai đoạn phát triển và toàn bộ ngân sách đã được giải ngân!',
    'detail.roadmap_milestones': 'Lộ trình & Giai đoạn',
    'detail.withdraw': 'Rút tiền',
    'detail.pending': 'Đang xử lý...',
    'detail.advantages': 'Thuận lợi',
    'detail.challenges': 'Khó khăn',
    'detail.expected_outcome': 'Kết quả kỳ vọng',
    'detail.official_update_report': 'Báo cáo Cập nhật Chính thức',
    'detail.completed': 'Hoàn thành',
    'detail.blockers': 'Trở ngại / Trì hoãn',
    ...
    'team.no_description': 'Chưa có mô tả.',
    'team.no_members': 'Chưa có thành viên nào trong đội ngũ.',
    'team.empty_hint': 'Thành viên đội ngũ được thêm khi tạo dự án.',
    ...
    'attachments.no_attachments_desc':
      'Dự án này chưa tải lên tài liệu hoặc tệp tin bổ sung nào.',
    'attachments.project_documents': 'Tài liệu dự án',
    'attachments.files_count': '({{count}} tệp)',
    'media.no_media': 'Không có hình ảnh/video',
    'media.images': 'Hình ảnh',
    'media.video': 'Video',
    'investors.title': 'Nhà đầu tư',
    'investors.empty': 'Chưa có nhà đầu tư nào. Hãy là người đầu tiên!',
    'investors.top': 'Hàng đầu',
    'investors.recent': 'Mới nhất',
    'investors.anonymous': 'Ẩn danh',
    'updates.submitted_late': 'Nộp muộn',
    'updates.progress_title': 'Tiến độ',
    'updates.blockers_title': 'Trở ngại',
    'updates.view_update': 'Xem cập nhật',
    'updates.hide': 'Ẩn',
    'updates.close': 'Đóng',
    'updates.edit_update': 'Chỉnh sửa cập nhật',
    'updates.update': 'Cập nhật',
    'updates.late_tag': '(Muộn)',
    'updates.complete_prev_first': 'Hoàn thành giai đoạn trước đó trước',
    'updates.starts_on': 'Bắt đầu từ {{date}}',
    'updates.no_milestones': 'Chưa xác định giai đoạn nào',
    'updates.no_milestones_desc': 'Các giai đoạn được thiết lập khi tạo dự án.',
    'updates.title': 'Cập nhật tiến độ',
    'updates.phases_count': '{{count}} giai đoạn',
    'updates.only_owner_can_submit':
      'Chỉ chủ dự án mới có quyền gửi báo cáo cập nhật tiến độ.',
    ...
    'reviews.delete_confirm':
      'Xóa bình luận này? Các phản hồi liên quan cũng sẽ bị xóa.',
    'reviews.delete_success': 'Xóa bình luận thành công!',
    ...
    'toast.like_success': 'Đã thích dự án thành công!',
    'toast.unlike_success': 'Đã bỏ thích dự án!',
    'toast.like_error': 'Thích dự án thất bại.',
    'toast.unlike_error': 'Bỏ thích dự án thất bại.',
    'toast.like_wallet_required': 'Vui lòng kết nối ví để thích dự án này.',
    ...
    'toast.email_invalid': 'Địa chỉ email không hợp lệ.',
    ...
    'toast.tx_rejected': 'Bạn đã hủy yêu cầu ký giao dịch.',
    ...
    'toast.invest_success': 'Đầu tư thành công!',
    'toast.amount_exceeds_remaining_usdt':
      'Bạn chỉ có thể đầu tư tối đa {{remaining}} USDT (số tiền còn thiếu của dự án)',
    'invest.title': 'ĐẦU TƯ DỰ ÁN',
    'invest.available_balance': 'Số dư khả dụng',
    'invest.amount_placeholder': 'Nhập số tiền USDT',
    'invest.optional_message': 'Lời nhắn động viên (Tùy chọn)',
    'invest.message_placeholder':
      'Bạn có muốn nhắn gửi điều gì đến Founder không?',
    'invest.confirm_btn': 'XÁC NHẬN ĐẦU TƯ',
    'invest.processing_btn': 'ĐANG XỬ LÝ...',
    'publish.title': 'Đưa lên Blockchain',
    'publish.description':
      'Dự án của bạn đã được Admin duyệt. Bây giờ bạn cần tạo Smart Contract cho dự án này trên chuỗi (Tốn phí Gas mạng Sepolia).',
    'publish.funding_goal': 'Mục tiêu gọi vốn:',
    'publish.milestones_count': 'Giai đoạn:',
    'publish.demo_mode': 'Chế độ thử nghiệm',
    'publish.demo_on': 'BẬT — Gọi vốn 5 phút, rút tiền ngay',
    'publish.demo_off': 'TẮT — Dùng Launch Date thực',
    'publish.confirm_btn': 'Xác nhận & Launch',
    'updates.form.success': 'Cập nhật được gửi thành công',
    'updates.form.late_warning':
      'Cập nhật này đã quá hạn chót của giai đoạn. Nó sẽ được đánh dấu là nộp muộn.',
    'updates.form.completed_label': 'Nội dung đã hoàn thành',
    'updates.form.completed_placeholder':
      'Mô tả những kết quả đã bàn giao trong giai đoạn này...',
    'updates.form.blockers_label': 'Trở ngại / Trì hoãn',
    'updates.form.blockers_placeholder':
      'Các khó khăn hoặc sự chậm trễ nếu có...',
    'updates.form.images_label': 'Hình ảnh tiến độ',
    'updates.form.images_helper': 'không bắt buộc · tối đa 4 ảnh',
    'updates.form.uploading_images': 'Đang tải lên hình ảnh...',
    'updates.form.upload_failed': 'Tải lên thất bại',
    'updates.form.upload_failed_desc': 'Không thể tải lên một số hình ảnh.',
    'updates.form.try_again': 'Vui lòng thử lại.',
    'updates.form.video_label': 'Video Demo',
    'updates.form.video_selected': 'Đã chọn video',
    'updates.form.video_upload_label': 'Tải lên video demo',
    'updates.form.video_uploading': 'Đang tải lên, vui lòng đợi...',
    'updates.form.video_click_replace': 'Nhấp để thay đổi',
    'updates.form.video_constraints': 'MP4, WEBM hoặc MOV · Tối đa 100MB',
    'updates.form.change': 'Thay đổi',
    'updates.form.upload': 'Tải lên',
    'updates.form.link_label': 'Liên kết ngoài',
    'updates.form.submit_failed': 'Cập nhật thất bại. Vui lòng thử lại.',
    'updates.form.submitting': 'Đang gửi...',
    'updates.form.submit_btn': 'Xác nhận',
    'withdraw.title': 'RÚT TIỀN GIAI ĐOẠN',
    'withdraw.milestone_label': 'Giai đoạn',
    'withdraw.amount_label': 'Số tiền',
    'withdraw.release_passed': 'Hạn rút tiền đã qua ({{date}})',
    'withdraw.release_pending': 'Chưa đến hạn rút: {{date}}',
    'withdraw.note': 'Lưu ý: ',
    ...
    'withdraw.admin_approved': 'Giai đoạn đã được Admin phê duyệt',
    'toast.sending_tx_blockchain': 'Đang gửi giao dịch lên Blockchain...',
    'toast.withdraw_success':
      'Yêu cầu rút tiền đã được ghi nhận! Hệ thống sẽ xác minh trong vài giây.',
    'toast.error_occurred': 'Đã có lỗi xảy ra',
    'withdraw.not_ready_btn': 'CHƯA ĐẾN HẠN RÚT',
    'withdraw.confirm_btn': 'XÁC NHẬN RÚT TIỀN',

    // Overview
    'overview.projectOverview': 'Tổng quan dự án',
    'content.core_vision': 'Tầm nhìn cốt lõi',
    'content.no_vision': 'Chưa cung cấp tầm nhìn dự án.',
    'content.comprehensive_details': 'Chi tiết toàn diện',
    'content.data_log': 'Nhật ký dữ liệu',
    'content.start': 'Bắt đầu',
    'content.end': 'Kết thúc',
    'content.location': 'Vị trí',
    'content.global_operations': 'Hoạt động toàn cầu',
    ...
    'stats.goal_reached_pct': '{{percent}}% mục tiêu tối thiểu đã đạt',
    'stats.days_left': 'Ngày còn lại',
    'stats.likes': 'Lượt thích',
    'stats.total_likes': '{{count}} Tổng lượt thích',
    'stats.total_reviews': '{{count}} Tổng đánh giá',
    ...
    // Landing / Stats
    'landing.stats.title': 'Thống kê Giao thức',
    'landing.stats.desc':
      'Theo dõi quy mô phát triển và hiện trạng hoạt động của các dự án trong hệ sinh thái phi tập trung.',
    'landing.stats.total': 'Tổng dự án',
    'landing.stats.total_desc': 'Các ý tưởng công nghệ đã khởi tạo',
    'landing.stats.fundraising': 'Đang gọi vốn',
    'landing.stats.fundraising_desc': 'Đang tiếp nhận nguồn vốn cộng đồng',
    'landing.stats.active': 'Đang hoạt động',
    'landing.stats.active_desc': 'Đang phát triển các giai đoạn cốt lõi',
    'landing.stats.success': 'Thành công',
    'landing.stats.success_desc': 'Hoàn thành và bàn giao dự án',
